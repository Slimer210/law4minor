            ...
            <section class="backlight-bottom">
                <div class="stg-row stg-bottom-gap-l">
                    <div class="stg-col-6 stg-offset-3 align-center">
                        ...
                        <p class="bringer-large-text" data-appear="fade-up" data-delay="100" data-unload="fade-up">We help teens reach their goals and believe every idea, no matter how big or small, should get the attention it deserves.</p>
                    </div>
                </div>
                ...
                <div class="stg-row bringer-section-title">
                    <div class="stg-col-8 stg-offset-2">
                        <div class="align-center">
                            ...
                            <p class="bringer-large-text" data-appear="fade-up" data-delay="100" data-unload="fade-up">Here's how you can connect with us:</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <ul class="bringer-socials-list stg-small-gap" data-stagger-appear="fade-up" data-stagger-delay="75">
                                ...
                                foreach ( $socials as $social => $name ) {
                                    $url = get_theme_mod( "bringer_social_{$social}_url" );
                                    $enabled = get_theme_mod( "bringer_social_{$social}_enabled" );
                                    if ( $enabled && ! empty( $url ) ) :
                                ?>
                                        <li>
                                            <a href="<?php echo esc_url( $url ); ?>" target="_blank" class="bringer-socials-<?php echo esc_attr( $social ); ?>">
                                                <i></i>
                                            </a>
                                        </li>
                                <?php
                            ...
                            <div class="bringer-cta-text">
                                <div class="stg-row stg-valign-middle">
                                    ...
                                    <div class="stg-col-8 stg-tp-col-7 stg-m-col-8 stg-m-offset-1" data-appear="fade-left">
                                        <p class="bringer-large-text">We help teens reach their goals and believe every idea, no matter how big or small, should get the attention it deserves.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
